...
public class CapacitorUpdaterPlugin extends Plugin {
  ...
  private static final DecryptStrategy defaultDecryptStrategy = new DecryptStrategy("private", defaultPrivateKey);
  ...
  public void load() {
    ...
    Gson gson = new Gson();
    this.implementation.privateKey = defaultPrivateKey;
    ...
    this.implementation.decryptStrategy = defaultDecryptStrategy;
    this.implementation.hasDecryptStrategyInConfig = false;
    if (this.getConfig().getObject("decryptStrategy") != null) {
      this.implementation.decryptStrategy = 
        gson.fromJson(this.getConfig().getObject("decryptStrategy").toString(), DecryptStrategy.class);
